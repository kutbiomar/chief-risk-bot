...
| P1-F09 Mobile/tablet visual proof | Deferred pending browser QA | Capture screenshots at 375, 390, 430, 768, and 1440 widths. | Static route contract and production route availability are now automated; CSS remains governed by `frontend-design-ideal/DESIGN.md`. |
